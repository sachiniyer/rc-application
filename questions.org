...
Draft Ideas:
- cgroups
- UT Austin Harmony elastic mechanic action
- Idea from Free Culture
- Emacs corfu (specifically Capf and miniwindow rendering in emacs)
- python rust dll interaction
